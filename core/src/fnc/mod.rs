...
pub fn synchronous(
	...
	dispatch!(
		...
		//
		"fake::address::building_number" => fake::address::building_number,
		"fake::address::city" => fake::address::city,
		"fake::address::country" => fake::address::country,
		"fake::address::country_code" => fake::address::country_code,
		"fake::address::state" => fake::address::state,
		"fake::address::street" => fake::address::street,
		"fake::address::zip" => fake::address::zip,
		"fake::barcode::isbn" => fake::barcode::isbn,
		"fake::barcode::isbn10" => fake::barcode::isbn10,
		"fake::barcode::isbn13" => fake::barcode::isbn13,
		...
		"fake::file::path" => fake::file::path,
		"fake::finance::bic" => fake::finance::bic,
		"fake::finance::credit_card" => fake::finance::credit_card,
		"fake::finance::isin" => fake::finance::isin,
		"fake::geo::latitude" => fake::geo::latitude,
		"fake::geo::longitude" => fake::geo::longitude,
