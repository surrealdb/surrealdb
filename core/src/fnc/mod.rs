	...
	match value {
		...
		_ => {
			...
			dispatch!(
				...
				//
				"to_array" => r#type::to::array,
				"to_bool" => r#type::to::bool,
				"to_bytes" => r#type::to::bytes,
				"to_collection" => r#type::to::collection,
				"to_datetime" => r#type::to::datetime,
				"to_decimal" => r#type::to::decimal,
				"to_duration" => r#type::to::duration,
				"to_float" => r#type::to::float,
				"to_geometry" => r#type::to::geometry,
				"to_int" => r#type::to::int,
				"to_line" => r#type::to::line,
				"to_null" => r#type::to::null,
				"to_multiline" => r#type::to::multiline,
				"to_multipoint" => r#type::to::multipoint,
				"to_multipolygon" => r#type::to::multipolygon,
				"to_number" => r#type::to::number,
				"to_object" => r#type::to::object,
				"to_point" => r#type::to::point,
				"to_polygon" => r#type::to::polygon,
				"to_record" => r#type::to::record,
				"to_string" => r#type::to::string,
