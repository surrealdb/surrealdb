...
pub(crate) static PATHS: phf::Map<UniCase<&'static str>, PathKind> = phf_map! {
		...
		//
		UniCase::ascii("fake::address::building_number") => PathKind::Function,
		UniCase::ascii("fake::address::city") => PathKind::Function,
		UniCase::ascii("fake::address::country") => PathKind::Function,
		UniCase::ascii("fake::address::country_code") => PathKind::Function,
		UniCase::ascii("fake::address::state") => PathKind::Function,
		UniCase::ascii("fake::address::street") => PathKind::Function,
		UniCase::ascii("fake::address::zip") => PathKind::Function,
		UniCase::ascii("fake::barcode::isbn") => PathKind::Function,
		UniCase::ascii("fake::barcode::isbn10")	=> PathKind::Function,
		UniCase::ascii("fake::barcode::isbn13")	=> PathKind::Function,
		UniCase::ascii("fake::company::name") => PathKind::Function,
		UniCase::ascii("fake::company::industry") => PathKind::Function,
		UniCase::ascii("fake::company::profession") => PathKind::Function,
		UniCase::ascii("fake::company::suffix") => PathKind::Function,
		UniCase::ascii("fake::company::tagline") => PathKind::Function,
		UniCase::ascii("fake::currency::code") => PathKind::Function,
		UniCase::ascii("fake::currency::name") => PathKind::Function,
		UniCase::ascii("fake::currency::symbol") => PathKind::Function,
		UniCase::ascii("fake::date::date") => PathKind::Function,
		UniCase::ascii("fake::date::datetime") => PathKind::Function,
		UniCase::ascii("fake::date::time") => PathKind::Function,
		UniCase::ascii("fake::file::dir_path") => PathKind::Function,
		UniCase::ascii("fake::file::extension") => PathKind::Function,
		UniCase::ascii("fake::file::name") => PathKind::Function,
		UniCase::ascii("fake::file::path") => PathKind::Function,
		UniCase::ascii("fake::finance::bic") => PathKind::Function,
		UniCase::ascii("fake::finance::credit_card") => PathKind::Function,
		UniCase::ascii("fake::finance::isin") => PathKind::Function,
		UniCase::ascii("fake::geo::latitude") => PathKind::Function,
		UniCase::ascii("fake::geo::longitude") => PathKind::Function,
		UniCase::ascii("fake::name::first_name") => PathKind::Function,
		UniCase::ascii("fake::name::full_name") => PathKind::Function,
		UniCase::ascii("fake::name::last_name") => PathKind::Function,
		UniCase::ascii("fake::name::suffix") => PathKind::Function,
		UniCase::ascii("fake::name::title") => PathKind::Function,
		UniCase::ascii("fake::internet::domain_extension") => PathKind::Function,
		UniCase::ascii("fake::internet::free_email") => PathKind::Function,
		UniCase::ascii("fake::internet::email") => PathKind::Function,
		UniCase::ascii("fake::internet::ipv6") => PathKind::Function,
		UniCase::ascii("fake::internet::ipv4") => PathKind::Function,
		UniCase::ascii("fake::internet::ip") => PathKind::Function,
		UniCase::ascii("fake::internet::mac_address") => PathKind::Function,
		UniCase::ascii("fake::internet::username") => PathKind::Function,
		UniCase::ascii("fake::internet::password") => PathKind::Function,
		UniCase::ascii("fake::internet::user_agent") => PathKind::Function,
		UniCase::ascii("fake::phone::number") => PathKind::Function,
		//
