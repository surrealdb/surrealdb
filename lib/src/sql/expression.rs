...
impl Expression {
	...
	pub(crate) async fn compute(
		...
		match o {
			...
			Operator::Contains => fnc::operate::contain(&l, &r),
			Operator::ContainsNot => fnc::operate::not_contain(&l, &r),
			Operator::ContainsAll => fnc::operate::contain_all(&l, &r),
			Operator::ContainsAny => fnc::operate::contain_any(&l, &r),
			Operator::ContainsNone => fnc::operate::contain_none(&l, &r),
