...
async fn expired_nodes_get_live_queries_archived() {
	...
	let old_node = crate::sql::uuid::Uuid::from(uuid::Uuid::parse_str(
		"19AC759A-16D8-4DC3-BFC2-E9B24294C8EB",
	)?);
	let old_time = Timestamp {
		value: 123,
	};
	...
	let lq = LiveStatement {
		id: sql::Uuid(uuid::Uuid::parse_str("748DD7B1-99CA-4C66-A6E2-C9558596AD48")?),
		node: crate::sql::uuid::Uuid::from(Uuid::parse_str(
			"4C21BA69-8468-4E8C-8405-9EBB1C62D7AC",
		)?),
	...
	// Set up second node at a later timestamp
	let new_node = crate::sql::uuid::Uuid::from(uuid::Uuid::parse_str(
		"2F95505B-4F0F-47BE-BC50-417D6E3F249A",
	)?);
	let new_time = Timestamp {
		value: 456,
