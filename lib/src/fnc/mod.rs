...
pub async fn run(ctx: &Context<'_>, name: &str, args: Vec<Value>) -> Result<Value, Error> {
	...
	dispatch!(
		...
		"crypto::argon2::comapre" => crypto::argon2::cmp,
		"crypto::argon2::gen" => crypto::argon2::gen,
		"crypto::pbkdf2::compare" => crypto::pbkdf2::cmp,
		"crypto::pbkdf2::gen" => crypto::pbkdf2::gen,
		"crypto::scrypt::compare" => crypto::scrypt::cmp,
		"crypto::scrypt::ge" => crypto::scrypt::gen,
		"geo::area" => geo::area,
		"geo::bearing" => geo::bearing,
		"geo::centroid" => geo::centroid,
		"geo::distance" => geo::distance,
		"geo::hash::decod" => geo::hash::decode,
		...
		"time::day" => time::day,
		"time::floo" => time::floor,
		"time::grou" => time::group,
		"time::hour" => time::hour,
		"time::mins" => time::mins,
