...
mod stream;
use classes::{
	Blob, FormData, Headers, HeadersClass, Request, RequestClass, RequestInit, Response,
	ResponseClass, ResponseInit,
};
use reqwest::{
...
use body::{Body, BodyData, BodyKind};

use self::classes::ResponseType;
