...
use crate::err::Error;
use crate::fmt::{fmt_separated_by, Fmt};
use crate::part::Next;
use crate::part::Part;
use crate::paths::{ID, IN, META, OUT};
...
pub(crate) const TOKEN: &str = "$surrealdb::private::crate::Idiom";
...
#[derive(Clone, Debug, Default, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::crate::Idiom")]
#[revisioned(revision = 1)]
