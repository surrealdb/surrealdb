...
pub(crate) const TOKEN: &str = "$surrealdb::private::crate::Value";
...
#[serde(rename = "$surrealdb::private::crate::Value")]
#[revisioned(revision = 1)]
pub enum Value {
...
mod tests {
	...
	fn check_size() {
		...
		assert_eq!(24, std::mem::size_of::<crate::number::Number>());
		assert_eq!(24, std::mem::size_of::<crate::strand::Strand>());
		assert_eq!(16, std::mem::size_of::<crate::duration::Duration>());
		assert_eq!(12, std::mem::size_of::<crate::datetime::Datetime>());
		assert_eq!(24, std::mem::size_of::<crate::array::Array>());
		assert_eq!(24, std::mem::size_of::<crate::object::Object>());
		assert_eq!(56, std::mem::size_of::<crate::geometry::Geometry>());
		assert_eq!(24, std::mem::size_of::<crate::param::Param>());
		assert_eq!(24, std::mem::size_of::<crate::idiom::Idiom>());
		assert_eq!(24, std::mem::size_of::<crate::table::Table>());
		assert_eq!(56, std::mem::size_of::<crate::thing::Thing>());
		assert_eq!(40, std::mem::size_of::<crate::mock::Mock>());
		assert_eq!(32, std::mem::size_of::<crate::regex::Regex>());
		assert_eq!(8, std::mem::size_of::<Box<crate::range::Range>>());
		assert_eq!(8, std::mem::size_of::<Box<crate::edges::Edges>>());
		assert_eq!(8, std::mem::size_of::<Box<crate::function::Function>>());
		assert_eq!(8, std::mem::size_of::<Box<crate::subquery::Subquery>>());
		assert_eq!(8, std::mem::size_of::<Box<crate::expression::Expression>>());
	}
