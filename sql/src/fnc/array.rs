...
use crate::array::Clump;
use crate::array::Combine;
use crate::array::Complement;
use crate::array::Difference;
use crate::array::Flatten;
use crate::array::Intersect;
use crate::array::Matches;
use crate::array::Transpose;
use crate::array::Union;
use crate::array::Uniq;
use crate::err::Error;
