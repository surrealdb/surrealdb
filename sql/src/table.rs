use crate::{escape::escape_ident, fmt::Fmt, strand::no_nul_bytes, Id, Ident, Thing};
...
pub(crate) const TOKEN: &str = "$surrealdb::private::crate::Table";
...
#[derive(Clone, Debug, Default, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::crate::Table")]
#[revisioned(revision = 1)]
