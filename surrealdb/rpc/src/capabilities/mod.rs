...
/// Which planner a session's read-only statements go through.
...
impl std::str::FromStr for NewPlannerStrategy {
	type Err = String;
...
impl Capabilities {
	...
	pub fn allowed_functions_ref(&self) -> &Targets<FuncTarget> {
		&self.allow_funcs
	}
