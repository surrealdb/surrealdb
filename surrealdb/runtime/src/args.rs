...
use surrealdb_expr::val::value::{Cast as CastTrait, Coerce};
use surrealdb_expr::val::{Value, convert_value_to_public_value};
...
/// Yields each argument with its 1-based position, which is what the error
/// messages report when one fails to convert.
...
impl_from_arg_via_coerce!(
	...
	surrealdb_expr::val::Array,
	surrealdb_expr::val::Object,
	surrealdb_expr::val::Bytes,
	surrealdb_expr::val::Datetime,
	surrealdb_expr::val::Duration,
	surrealdb_expr::val::File,
	surrealdb_expr::val::Geometry,
	surrealdb_expr::val::Number,
	surrealdb_expr::val::Regex,
	surrealdb_expr::val::RecordId,
	surrealdb_expr::val::Uuid,
	surrealdb_expr::val::Set,
	surrealdb_expr::val::TableName,
);
