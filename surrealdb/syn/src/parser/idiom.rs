...
use surrealdb_sql::part::{DestructurePart, Recurse, RecurseInstruction};
use surrealdb_sql::{Dir, Expr, Field, Fields, Idiom, Literal, Lookup, Param, Part};
...
mod tests {
	...
	use surrealdb_sql::{self, BinaryOperator, RecordIdKeyLit, RecordIdLit};
