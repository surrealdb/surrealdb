pub use common::keywords::{RESERVED_KEYWORD, could_be_reserved};
use phf::phf_map;
use surrealdb_sql::Algorithm;
use surrealdb_sql::language::Language;
use unicase::UniCase;

use crate::token::{DistanceKind, Keyword, TokenKind, VectorTypeKind};

/// A map for mapping keyword strings to a tokenkind,
pub static KEYWORDS: phf::Map<UniCase<&'static str>, TokenKind> = phf_map! {
	// Keywords
	...
	UniCase::ascii("MAXDEPTH") => TokenKind::Keyword(Keyword::MaxDepth),
	...
	UniCase::ascii("PASSSCRAM") => TokenKind::Keyword(Keyword::Passscram),
	...
	UniCase::ascii("RETRY") => TokenKind::Keyword(Keyword::Retry),
	...
	UniCase::ascii("UNSIGNED") => TokenKind::Keyword(Keyword::Unsigned),
