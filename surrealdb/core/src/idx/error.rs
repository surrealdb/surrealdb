...
//! and highlighters behind full-text search, and the planner's search for an
//! index able to support a given expression.
...
pub(crate) fn index_exists_record(error: &anyhow::Error) -> Option<RecordId> {
