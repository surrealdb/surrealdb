...
//!
//! `file_allowlist` belongs here for the same reason, less obviously. The
//! allowlist is only ever *enforced* by `crate::iam::file::check_is_path_allowed`,
//! and its only callers are the two analyzer mapper loaders —
