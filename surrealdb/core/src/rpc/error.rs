...
pub fn parse_error() -> TypesError {
	TypesError::new(TypesErrorKind::Validation, "Parse error".to_string()).with_code(code::PARSE_ERROR)
}

/// Invalid request structure.
pub fn invalid_request() -> TypesError {
	TypesError::new(TypesErrorKind::Validation, "Invalid request".to_string())
		.with_code(code::INVALID_REQUEST)
}

/// Method not found.
pub fn method_not_found() -> TypesError {
	TypesError::new(TypesErrorKind::Method, "Method not found".to_string())
		.with_code(code::METHOD_NOT_FOUND)
}

/// Method not allowed.
pub fn method_not_allowed() -> TypesError {
	TypesError::new(TypesErrorKind::Method, "Method not allowed".to_string())
...
pub fn invalid_params(msg: impl Into<String>) -> TypesError {
	TypesError::new(TypesErrorKind::Validation, msg.into()).with_code(code::INVALID_PARAMS)
}
...
pub fn bad_gql_config() -> TypesError {
	TypesError::new(TypesErrorKind::Configuration, "Bad GraphQL config".to_string())
		.with_code(code::BAD_GRAPHQL_CONFIG)
}

/// User-thrown / database-thrown error.
pub fn thrown(msg: impl Into<String>) -> TypesError {
	TypesError::new(TypesErrorKind::Thrown, msg.into()).with_code(code::THROWN)
}

/// Serialization error.
pub fn serialize(msg: impl Into<String>) -> TypesError {
	TypesError::new(TypesErrorKind::Serialization, msg.into()).with_code(code::SERIALIZATION_ERROR)
}

/// Deserialization error.
pub fn deserialize(msg: impl Into<String>) -> TypesError {
	TypesError::new(TypesErrorKind::Serialization, msg.into())
		.with_code(code::DESERIALIZATION_ERROR)
}
