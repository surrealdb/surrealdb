...
#[rstest]
#[case::plain("DEFINE MODULE mod::helpers AS f\"test:/demo.surli\"")]
#[case::reserved("DEFINE MODULE mod::`select` AS f\"test:/demo.surli\"")]
#[case::spaced("DEFINE MODULE mod::`my module` AS f\"test:/demo.surli\"")]
#[case::digit_leading("DEFINE MODULE mod::`1st` AS f\"test:/demo.surli\"")]
#[case::backtick("DEFINE MODULE mod::`odd\\`name` AS f\"test:/demo.surli\"")]
