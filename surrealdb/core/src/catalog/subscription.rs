...
pub(crate) enum StoredSubscriptionFields {
	Diff,
...
pub(crate) const INERT_SUBSCRIPTION_MARKER: &str =
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(crate) enum SubscriptionQuery {
...
impl SubscriptionQuery {
	...
	pub(crate) fn compiled(&self) -> Option<&CompiledSubscription> {
		match self {
...
impl SubscriptionDefinition {
	...
	pub(crate) fn compile(stored: &StoredSubscriptionDefinition) -> SubscriptionDefinition {
	...
	pub(crate) fn to_stored(&self) -> StoredSubscriptionDefinition {
