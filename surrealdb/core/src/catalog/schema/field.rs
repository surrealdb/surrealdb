...
pub(crate) enum StoredDefineDefault {
	#[default]
	None,
...
pub struct StoredFieldDefinition {
	...
	pub(crate) name: IdiomText,
	pub(crate) table: TableName,
	/// Canonical SurrealQL kind-grammar text of the `TYPE` clause.
	#[revision(end = 5, convert_fn = "convert_field_kind")]
	pub(crate) old_field_kind: Option<Kind>,
	#[revision(start = 5)]
	pub(crate) field_kind: Option<KindText>,
	pub(crate) flexible: bool,
	pub(crate) readonly: bool,
	/// Canonical SurrealQL text of the `VALUE` clause's expression.
	pub(crate) value: Option<ExprText>,
	/// Canonical SurrealQL text of the `ASSERT` clause's expression.
	pub(crate) assert: Option<ExprText>,
	/// Canonical SurrealQL text of the `COMPUTED` clause's expression.
	pub(crate) computed: Option<ExprText>,
	pub(crate) default: StoredDefineDefault,

	pub(crate) select_permission: StoredPermission,
	pub(crate) create_permission: StoredPermission,
	pub(crate) update_permission: StoredPermission,

	pub(crate) comment: Option<String>,
	pub(crate) reference: Option<StoredReference>,
...
impl FieldDefinition {
	...
	pub(crate) fn to_sql_definition(
		&self,
	...
	pub(crate) fn to_sql_overwrite(&self) -> String {
...
impl DefineDefault {
	pub(crate) fn to_stored(&self) -> StoredDefineDefault {
		match self {
...
impl FieldDefinition {
	pub(crate) fn to_stored(&self) -> StoredFieldDefinition {
		StoredFieldDefinition {
			...
			select_permission: self.select_permission.to_stored(),
			create_permission: self.create_permission.to_stored(),
			update_permission: self.update_permission.to_stored(),
