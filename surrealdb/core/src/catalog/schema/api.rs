...
pub struct StoredApiDefinition {
	...
	pub(crate) path: PathText,
	/// The actions of the API.
	pub(crate) actions: Vec<StoredApiActionDefinition>,
	/// Canonical SurrealQL text of the fallback (`THEN`) clause's expression.
	pub(crate) fallback: Option<ExprText>,
	/// The config of the API.
	pub(crate) config: StoredApiConfigDefinition,
...
impl ApiConfig {
	pub(crate) fn to_stored(&self) -> StoredApiConfigDefinition {
...
impl ApiAction {
	pub(crate) fn to_stored(&self) -> StoredApiActionDefinition {
...
impl ApiDefinition {
	...
	pub(crate) fn to_stored(&self) -> StoredApiDefinition {
		StoredApiDefinition {
