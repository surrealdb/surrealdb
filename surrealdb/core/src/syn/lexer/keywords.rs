...
pub(crate) static KEYWORDS: phf::Map<UniCase<&'static str>, TokenKind> = phf_map! {
	...
	UniCase::ascii("PER") => TokenKind::Keyword(Keyword::Per),
	...
	UniCase::ascii("RATELIMIT") => TokenKind::Keyword(Keyword::RateLimit),
	...
	UniCase::ascii("SCAN") => TokenKind::Keyword(Keyword::Scan),
