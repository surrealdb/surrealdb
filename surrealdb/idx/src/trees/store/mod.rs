...
#[cfg(diskann)]
use crate::trees::store::diskann::{DiskAnnIndexes, SharedDiskAnnIndex};
use crate::trees::store::hnsw::{HnswIndexes, SharedHnswIndex};
use crate::trees::store::mapper::Mappers;
...
impl IndexStores {
	pub fn new(hnsw_cache_size: u64, diskann_cache_size: u64) -> Self {
		#[cfg(not(diskann))]
	...
	pub async fn remove_hnsw_index(&self, tb: TableId, ikb: IndexKeyBase) -> Result<()> {
