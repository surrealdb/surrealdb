...
#[cfg(not(target_family = "wasm"))]
use crate::trees::diskann::index::{DiskAnnContext, DiskAnnGraph};
use crate::trees::diskann::{DiskAnnElement, ElementId};
...
#[cfg(not(target_family = "wasm"))]
pub(crate) struct DiskAnnVecDocs {
