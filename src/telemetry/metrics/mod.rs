...
fn build_meter_provider() -> Result<MeterProvider, MetricsError> {
...
pub fn init() {
	let meter_provider = build_meter_provider().expect("Failed to initialize metrics provider");
