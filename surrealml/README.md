...
- **core:** This pure rust module handles the storage, loading, and running of ML models. `Core` is compiled into the SurrealDB server so the ML execution code runs on the server.
