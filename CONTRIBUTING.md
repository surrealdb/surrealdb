...
Many tests have recently moved to the [language-tests](https://github.com/surrealdb/surrealdb/tree/main/surrealdb/language-tests) crate which allows a test to be created using only SurrealQL via a .toml file which includes the queries and expected output. An example of a test:
