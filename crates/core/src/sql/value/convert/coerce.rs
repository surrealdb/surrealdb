...
use crate::sql::{
	Array, Bytes, Closure, Datetime, Duration, File, Geometry, Ident, Kind, KindLiteral, Number,
...
impl SqlValue {
	...
	pub(crate) fn coerce_to_literal(self, literal: &KindLiteral) -> Result<SqlValue, CoerceError> {
