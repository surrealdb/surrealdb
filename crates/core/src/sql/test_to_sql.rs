...
#[case::top_level_use(TopLevelExpr::Use(UseStatement { ns: Some(Expr::Idiom(Idiom::field("ns".to_string()))), db: Some(Expr::Idiom(Idiom::field("db".to_string()))) }), "USE NS ns DB db", "USE NS ns DB db")]
