...
crate::expr::impl_display_from_sql!(GraphQLConfig);

impl crate::expr::DisplaySql for GraphQLConfig {
...
crate::expr::impl_display_from_sql!(TablesConfig);

impl crate::expr::DisplaySql for TablesConfig {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
		match self {
...
crate::expr::impl_display_from_sql!(TableConfig);

impl crate::expr::DisplaySql for TableConfig {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
		write!(f, "{}", self.name)?;
		Ok(())
	}
...
crate::expr::impl_display_from_sql!(FunctionsConfig);

impl crate::expr::DisplaySql for FunctionsConfig {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
		match self {
