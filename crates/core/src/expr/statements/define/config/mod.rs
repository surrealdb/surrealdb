...
crate::expr::impl_display_from_sql!(DefineConfigStatement);

impl crate::expr::DisplaySql for DefineConfigStatement {
...
crate::expr::impl_display_from_sql!(ConfigInner);

impl crate::expr::DisplaySql for ConfigInner {
