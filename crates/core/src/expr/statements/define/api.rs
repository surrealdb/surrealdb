...
use crate::expr::fmt::{pretty_indent, Fmt};
...
crate::expr::impl_display_from_sql!(DefineApiStatement);

impl crate::expr::DisplaySql for DefineApiStatement {
...
crate::expr::impl_display_from_sql!(ApiDefinition);

impl crate::expr::DisplaySql for ApiDefinition {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
crate::expr::impl_display_from_sql!(ApiAction);

impl crate::expr::DisplaySql for ApiAction {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
