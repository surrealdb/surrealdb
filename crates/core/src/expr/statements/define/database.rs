...
use crate::expr::{changefeed::ChangeFeed, Base, Ident, Strand, Value};
...
crate::expr::impl_display_from_sql!(DefineDatabaseStatement);

impl crate::expr::DisplaySql for DefineDatabaseStatement {
