...
crate::expr::impl_display_from_sql!(RebuildStatement);

impl crate::expr::DisplaySql for RebuildStatement {
...
crate::expr::impl_display_from_sql!(RebuildIndexStatement);

impl crate::expr::DisplaySql for RebuildIndexStatement {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
