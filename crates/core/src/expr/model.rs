...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Model";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Default, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Model")]
...
crate::expr::impl_display_from_sql!(Model);

impl crate::expr::DisplaySql for Model {
