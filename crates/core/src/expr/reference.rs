...
#[serde(rename = "$surrealdb::private::expr::Reference")]
...
crate::expr::impl_display_from_sql!(Reference);

impl crate::expr::DisplaySql for Reference {
...
#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize, Hash, PartialOrd)]
#[serde(rename = "$surrealdb::private::expr::ReferenceDeleteStrategy")]
#[cfg_attr(feature = "arbitrary", derive(arbitrary::Arbitrary))]
#[non_exhaustive]
...
crate::expr::impl_display_from_sql!(ReferenceDeleteStrategy);

impl crate::expr::DisplaySql for ReferenceDeleteStrategy {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
		match self {
...
#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize, Hash, PartialOrd)]
#[serde(rename = "$surrealdb::private::expr::Refs")]
#[cfg_attr(feature = "arbitrary", derive(arbitrary::Arbitrary))]
#[non_exhaustive]
...
crate::expr::impl_display_from_sql!(Refs);

impl crate::expr::DisplaySql for Refs {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
		write!(f, "[]")
	}
}
