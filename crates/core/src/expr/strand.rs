...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Strand";
...
#[serde(rename = "$surrealdb::private::expr::Strand")]
...
crate::expr::impl_display_from_sql!(Strand);

impl crate::expr::DisplaySql for Strand {
