...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Closure";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Closure")]
...
crate::expr::impl_display_from_sql!(Closure);

impl crate::expr::DisplaySql for Closure {
