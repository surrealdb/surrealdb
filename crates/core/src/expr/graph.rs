...
crate::expr::impl_display_from_sql!(Graph);

impl crate::expr::DisplaySql for Graph {
...
crate::expr::impl_display_from_sql!(GraphSubjects);

impl crate::expr::DisplaySql for GraphSubjects {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
...
crate::expr::impl_display_from_sql!(GraphSubject);

impl crate::expr::DisplaySql for GraphSubject {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
		match self {
