...
use crate::expr::{escape::EscapeRid, id::Id, Strand, Value};
use crate::syn;
...
const ID: &str = "id";
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Thing";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, Ord, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Thing")]
...
crate::expr::impl_display_from_sql!(Thing);

impl crate::expr::DisplaySql for Thing {
