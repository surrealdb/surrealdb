...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Range";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Range")]
...
crate::expr::impl_display_from_sql!(Range);

impl crate::expr::DisplaySql for Range {
