...
crate::expr::impl_display_from_sql!(Part);

impl crate::expr::DisplaySql for Part {
...
crate::expr::impl_display_from_sql!(DestructurePart);

impl crate::expr::DisplaySql for DestructurePart {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
		match self {
...
crate::expr::impl_display_from_sql!(Recurse);

impl crate::expr::DisplaySql for Recurse {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
		match self {
...
crate::expr::impl_display_from_sql!(RecurseInstruction);

impl crate::expr::DisplaySql for RecurseInstruction {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
		match self {
			Self::Path {
				inclusive,
