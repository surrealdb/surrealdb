...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Subquery";

#[revisioned(revision = 5)]
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Subquery")]
...
crate::expr::impl_display_from_sql!(Subquery);

impl crate::expr::DisplaySql for Subquery {
