...
crate::expr::impl_display_from_sql!(Fetchs);

impl crate::expr::DisplaySql for Fetchs {
...
crate::expr::impl_display_from_sql!(Fetch);

impl crate::expr::DisplaySql for Fetch {
