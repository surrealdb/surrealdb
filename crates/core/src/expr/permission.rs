...
crate::expr::impl_display_from_sql!(Permissions);

impl crate::expr::DisplaySql for Permissions {
...
crate::expr::impl_display_from_sql!(PermissionKind);

impl crate::expr::DisplaySql for PermissionKind {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
...
crate::expr::impl_display_from_sql!(Permission);

impl crate::expr::DisplaySql for Permission {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
		match self {
