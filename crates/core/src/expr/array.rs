...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Array";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Default, Eq, Ord, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Array")]
...
crate::expr::impl_display_from_sql!(Array);

impl crate::expr::DisplaySql for Array {
