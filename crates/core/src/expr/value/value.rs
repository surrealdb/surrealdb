...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Value";
...
crate::expr::impl_display_from_sql!(Values);

impl crate::expr::DisplaySql for Values {
...
#[serde(rename = "$surrealdb::private::expr::Value")]
#[cfg_attr(feature = "arbitrary", derive(arbitrary::Arbitrary))]
#[non_exhaustive]
pub enum Value {
...
crate::expr::impl_display_from_sql!(Value);

impl crate::expr::DisplaySql for Value {
