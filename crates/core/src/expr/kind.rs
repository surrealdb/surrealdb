...
crate::expr::impl_display_from_sql!(Kind);

impl crate::expr::DisplaySql for Kind {
...
crate::expr::impl_display_from_sql!(Literal);

impl crate::expr::DisplaySql for Literal {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
		match self {
