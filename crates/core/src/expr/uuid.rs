...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Uuid";

#[revisioned(revision = 1)]
#[derive(
	Clone, Copy, Debug, Default, Eq, Ord, PartialEq, PartialOrd, Serialize, Deserialize, Hash,
)]
#[serde(rename = "$surrealdb::private::expr::Uuid")]
...
crate::expr::impl_display_from_sql!(Uuid);

impl crate::expr::DisplaySql for Uuid {
