...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Function";

#[revisioned(revision = 2)]
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Function")]
...
crate::expr::impl_display_from_sql!(Function);

impl crate::expr::DisplaySql for Function {
