...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Expression";

/// Binary expressions.
#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Expression")]
...
crate::expr::impl_display_from_sql!(Expression);

impl crate::expr::DisplaySql for Expression {
