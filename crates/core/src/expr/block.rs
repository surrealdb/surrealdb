...
use crate::expr::fmt::{is_pretty, pretty_indent, Fmt, Pretty};
...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Block";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Default, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Block")]
...
crate::expr::impl_display_from_sql!(Block);

impl crate::expr::DisplaySql for Block {
...
crate::expr::impl_display_from_sql!(Entry);

impl crate::expr::DisplaySql for Entry {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
		match self {
