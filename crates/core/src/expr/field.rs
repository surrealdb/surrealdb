...
use crate::expr::{fmt::Fmt, Idiom, Part, Value};
use crate::syn;
...
crate::expr::impl_display_from_sql!(Fields);

impl crate::expr::DisplaySql for Fields {
...
crate::expr::impl_display_from_sql!(Field);

impl crate::expr::DisplaySql for Field {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
		match self {
