...
crate::expr::impl_display_from_sql!(Accesses);

impl crate::expr::DisplaySql for Accesses {
...
#[revisioned(revision = 1)]
#[derive(Clone, Debug, Default, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Access")]
#[cfg_attr(feature = "arbitrary", derive(arbitrary::Arbitrary))]
#[non_exhaustive]
...
crate::expr::impl_display_from_sql!(Access);

impl crate::expr::DisplaySql for Access {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
