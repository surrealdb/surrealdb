...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Duration";

#[revisioned(revision = 1)]
#[derive(
	Clone, Copy, Debug, Default, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash, Ord,
)]
#[serde(rename = "$surrealdb::private::expr::Duration")]
#[non_exhaustive]
...
crate::expr::impl_display_from_sql!(Duration);

impl crate::expr::DisplaySql for Duration {
