use crate::expr::{escape::EscapeIdent, fmt::Fmt, strand::no_nul_bytes, Id, Ident, Thing};
...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Table";
...
crate::expr::impl_display_from_sql!(Tables);

impl crate::expr::DisplaySql for Tables {
...
#[revisioned(revision = 1)]
#[derive(Clone, Debug, Default, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash, Ord)]
#[serde(rename = "$surrealdb::private::expr::Table")]
#[cfg_attr(feature = "arbitrary", derive(arbitrary::Arbitrary))]
#[non_exhaustive]
...
crate::expr::impl_display_from_sql!(Table);

impl crate::expr::DisplaySql for Table {
	fn fmt_sql(&self, f: &mut Formatter) -> fmt::Result {
