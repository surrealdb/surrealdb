...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Datetime";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, PartialOrd, Ord, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Datetime")]
#[non_exhaustive]
...
crate::expr::impl_display_from_sql!(Datetime);

impl crate::expr::DisplaySql for Datetime {
