...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Constant";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Constant")]
...
crate::expr::impl_display_from_sql!(Constant);

impl crate::expr::DisplaySql for Constant {
