...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Number";

#[revisioned(revision = 1)]
#[derive(Clone, Copy, Serialize, Deserialize, Debug)]
#[serde(rename = "$surrealdb::private::expr::Number")]
...
crate::expr::impl_display_from_sql!(Number);

impl crate::expr::DisplaySql for Number {
