...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Idiom";
...
crate::expr::impl_display_from_sql!(Idioms);

impl crate::expr::DisplaySql for Idioms {
...
#[revisioned(revision = 1)]
#[derive(Clone, Debug, Default, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Idiom")]
#[cfg_attr(feature = "arbitrary", derive(arbitrary::Arbitrary))]
#[non_exhaustive]
...
crate::expr::impl_display_from_sql!(Idiom);

impl crate::expr::DisplaySql for Idiom {
