...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::File";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize, Hash, PartialOrd)]
#[serde(rename = "$surrealdb::private::expr::File")]
...
crate::expr::impl_display_from_sql!(File);

impl crate::expr::DisplaySql for File {
