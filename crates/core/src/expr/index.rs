...
crate::expr::impl_display_from_sql!(Distance);

impl crate::expr::DisplaySql for Distance {
...
crate::expr::impl_display_from_sql!(VectorType);

impl crate::expr::DisplaySql for VectorType {
	fn fmt_sql(&self, f: &mut Formatter<'_>) -> fmt::Result {
		match self {
...
crate::expr::impl_display_from_sql!(Index);

impl crate::expr::DisplaySql for Index {
