	...
	pub fn into_object(self) -> Object {
		...
		Object::from(match self {
			Operation::Add {
				...
				map! {
					"op".to_owned() => Value::String("add".into()),
			...
			Operation::Remove {
				...
				map! {
					...
					"op".to_owned() => Value::String("remove".into()),
					// TODO: Ensure null byte correctness
					"path".to_owned() => path_to_strand(&path),
				}
			}
			Operation::Replace {
				...
				map! {
					// safety: does not contain null bytes.
					"op".to_owned() => Value::String("replace".into()),
					// TODO: Ensure null byte correctness
					"path".to_owned() => path_to_strand(&path),
					"value".to_owned() => value,
				}
			...
			Operation::Change {
				...
				map! {
					// safety: does not contain null bytes.
					"op".to_owned() => Value::String("change".into()),
					// TODO: Ensure null byte correctness
					"path".to_owned() => path_to_strand(&path),
					"value".to_owned() => value,
				}
			...
			Operation::Copy {
				...
				map! {
					// safety: does not contain null bytes.
					"op".to_owned() => Value::String("copy".into()),
					// TODO: Ensure null byte correctness
					"path".to_owned() => path_to_strand(&path),
			...
			Operation::Move {
				...
				map! {
					// safety: does not contain null bytes.
					"op".to_owned() => Value::String("map".into()),
					// TODO: Ensure null byte correctness
					"path".to_owned() => path_to_strand(&path),
					"from".to_owned() => path_to_strand(&from),
				}
			...
			Operation::Test {
				...
				map! {
					// safety: does not contain null bytes.
					"op".to_owned() => Value::String("test".into()),
					// TODO: Ensure null byte correctness
					"path".to_owned() => path_to_strand(&path),
					"value".to_owned() => value,
				}
