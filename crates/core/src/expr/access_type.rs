...
use crate::expr::{escape::QuoteStr, Algorithm};
...
crate::expr::impl_display_from_sql!(AccessType);

impl crate::expr::DisplaySql for AccessType {
...
crate::expr::impl_display_from_sql!(JwtAccess);

impl crate::expr::DisplaySql for JwtAccess {
	fn fmt_sql(&self, f: &mut fmt::Formatter) -> fmt::Result {
		match &self.verify {
