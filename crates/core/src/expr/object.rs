...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Object";

/// Invariant: Keys never contain NUL bytes.
#[revisioned(revision = 1)]
#[derive(Clone, Debug, Default, Eq, Ord, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Object")]
...
crate::expr::impl_display_from_sql!(Object);

impl crate::expr::DisplaySql for Object {
