...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Cast";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Cast")]
...
crate::expr::impl_display_from_sql!(Cast);

impl crate::expr::DisplaySql for Cast {
