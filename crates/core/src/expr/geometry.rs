...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Geometry";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(rename = "$surrealdb::private::expr::Geometry")]
...
crate::expr::impl_display_from_sql!(Geometry);

impl crate::expr::DisplaySql for Geometry {
