...
pub(crate) const TOKEN: &str = "$surrealdb::private::expr::Param";

#[revisioned(revision = 1)]
#[derive(Clone, Debug, Default, Eq, PartialEq, PartialOrd, Serialize, Deserialize, Hash)]
#[serde(rename = "$surrealdb::private::expr::Param")]
...
crate::expr::impl_display_from_sql!(Param);

impl crate::expr::DisplaySql for Param {
