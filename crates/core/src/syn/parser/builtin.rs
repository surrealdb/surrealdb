...
pub(crate) static PATHS: phf::Map<UniCase<&'static str>, PathKind> = phf_map! {
		...
		UniCase::ascii("array::sequence") => PathKind::Function,
		...
		//
		UniCase::ascii("number::format") => PathKind::Function,
		//
		...
		UniCase::ascii("set::at") => PathKind::Function,
		...
		UniCase::ascii("set::filter") => PathKind::Function,
		UniCase::ascii("set::find") => PathKind::Function,
		UniCase::ascii("set::first") => PathKind::Function,
		UniCase::ascii("set::flatten") => PathKind::Function,
		UniCase::ascii("set::fold") => PathKind::Function,
		UniCase::ascii("set::intersect") => PathKind::Function,
		UniCase::ascii("set::is_empty") => PathKind::Function,
		UniCase::ascii("set::join") => PathKind::Function,
		UniCase::ascii("set::last") => PathKind::Function,
		UniCase::ascii("set::len") => PathKind::Function,
		UniCase::ascii("set::map") => PathKind::Function,
		UniCase::ascii("set::max") => PathKind::Function,
		UniCase::ascii("set::min") => PathKind::Function,
		UniCase::ascii("set::reduce") => PathKind::Function,
		UniCase::ascii("set::remove") => PathKind::Function,
		UniCase::ascii("set::slice") => PathKind::Function,
