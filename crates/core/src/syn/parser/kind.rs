...
mod tests {
	...
	#[case::point("point", "geometry<point>", Kind::Geometry(vec![PublicGeometryKind::Point]))]
	...
	#[case::geometry_one("geometry<point>", "geometry<point>", Kind::Geometry(vec![PublicGeometryKind::Point]))]
	#[case::geometry_many("geometry<point | multipoint>", "geometry<point | multipoint>", Kind::Geometry(vec![PublicGeometryKind::Point, PublicGeometryKind::MultiPoint]))]
