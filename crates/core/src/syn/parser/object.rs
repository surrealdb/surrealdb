...
mod tests {
	...
	fn simple() {
		...
		assert_eq!("(-0.118092f, 51.509865f)", format!("{}", out));
	}
	...
	fn polygon_exterior() {
		...
		let out = Value::parse(sql);
		assert!(matches!(out, Value::Geometry(_)));
		assert_eq!("{ type: 'Polygon', coordinates: [[[-0.38314819f, 51.37692386f], [0.1785278f, 51.37692386f], [0.1785278f, 51.6146057f], [-0.38314819f, 51.6146057f], [-0.38314819f, 51.37692386f]]] }", format!("{}", out));
	}
	...
	fn polygon_interior() {
		...
		let out = Value::parse(sql);
		assert!(matches!(out, Value::Geometry(_)));
		assert_eq!("{ type: 'Polygon', coordinates: [[[-0.38314819f, 51.37692386f], [0.1785278f, 51.37692386f], [0.1785278f, 51.6146057f], [-0.38314819f, 51.6146057f], [-0.38314819f, 51.37692386f]], [[-0.38314819f, 51.37692386f], [0.1785278f, 51.37692386f], [0.1785278f, 51.6146057f], [-0.38314819f, 51.6146057f], [-0.38314819f, 51.37692386f]]] }", format!("{}", out));
	}
}
