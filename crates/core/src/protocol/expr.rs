        ...
        let args = match self {
            ...
            Self::Bytes(b) => {
                ...
                expr_fb::ValueArgs {
                    ...
                    value: Some(expr_fb::Bytes::create(builder, &expr_fb::BytesArgs { value: Some(bytes) }).as_union_value())
                }
        },
...
impl ToFlatbuffers for Decimal {
    type Output<'bldr> = flatbuffers::WIPOffset<expr_fb::Decimal<'bldr>>;
    ...
    fn to_fb<'bldr>(
        ...
        expr_fb::Decimal::create(builder, &expr_fb::DecimalArgs {
            value: Some(value),
        })
    }
}
...
impl ToFlatbuffers for Duration {
    type Output<'bldr> = flatbuffers::WIPOffset<expr_fb::Duration<'bldr>>;

    fn to_fb<'bldr>(
        &self,
        builder: &mut flatbuffers::FlatBufferBuilder<'bldr>,
    ) -> Self::Output<'bldr> {
        expr_fb::Duration::create(builder, &expr_fb::DurationArgs {
...
impl FromFlatbuffers for Duration {
    type Input<'a> = expr_fb::Duration<'a>;
...
impl ToFlatbuffers for DateTime<Utc> {
    type Output<'bldr> = flatbuffers::WIPOffset<expr_fb::Timestamp<'bldr>>;

    fn to_fb<'bldr>(
        &self,
        builder: &mut flatbuffers::FlatBufferBuilder<'bldr>,
    ) -> Self::Output<'bldr> {
        expr_fb::Timestamp::create(builder, &expr_fb::TimestampArgs {
...
impl FromFlatbuffers for DateTime<Utc> {
    type Input<'a> = expr_fb::Timestamp<'a>;
...
impl ToFlatbuffers for Uuid {
    type Output<'bldr> = flatbuffers::WIPOffset<expr_fb::Uuid<'bldr>>;
    ...
    fn to_fb<'bldr>(
        ...
        let bytes = builder.create_vector(self.as_bytes());
         // Create a Uuid FlatBuffer object with the bytes
         // Note: The UuidArgs struct is used to pass the bytes to the create function
        expr_fb::Uuid::create(builder, &expr_fb::UuidArgs {
            bytes: Some(bytes),
        })
    }
}
