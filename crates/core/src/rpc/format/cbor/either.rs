use super::{decode::{Decoder, TryDecode}, err::Error, major::Major, types::TypeName};
...
{
    fn type_name() -> String {
        format!("{}, {}, {}, {}, {} or {}", A::type_name(), B::type_name(), C::type_name(), D::type_name(), E::type_name(), F::type_name())
    }
}