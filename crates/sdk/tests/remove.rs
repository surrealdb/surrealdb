...
async fn permissions_checks_remove_root_user() {
	...
	let check_results = [
		vec!["{ accesses: {  }, namespaces: {  }, nodes: {  }, system: { available_parallelism: 0, cpu_usage: 0f, load_average: [0f, 0f, 0f], memory_allocated: 0, memory_usage: 0, physical_cores: 0, threads: 0 }, users: {  } }"],
        vec!["{ accesses: {  }, namespaces: {  }, nodes: {  }, system: { available_parallelism: 0, cpu_usage: 0f, load_average: [0f, 0f, 0f], memory_allocated: 0, memory_usage: 0, physical_cores: 0, threads: 0 }, users: { user: \"DEFINE USER user ON ROOT PASSHASH 'secret' ROLES VIEWER DURATION FOR TOKEN 1h, FOR SESSION NONE\" } }"],
    ];
